				...
				if (Step.valueOf(doc.getString("step")).equals(Step.CHOOSING)) {
					...
					try {
									...
									.queue(message -> {
										...
										e.getChannel().getManager().putPermissionOverride(e.getMember(),
												...
												EnumSet.of(Permission.MANAGE_CHANNEL, Permission.MANAGE_WEBHOOKS,
														...
														Permission.USE_SLASH_COMMANDS, Permission.MESSAGE_EMBED_LINKS,
						...
						case "1st column":
							...
							round.getChannel().sendMessage(msg111111111.build()).append(e.getMember().getAsMention())
									.queue(message -> {
										message.delete().queueAfter(5, TimeUnit.SECONDS);
										e.getChannel().getManager().putPermissionOverride(e.getMember(),
												EnumSet.of(Permission.VIEW_CHANNEL, Permission.MESSAGE_WRITE,
						...
						case "2nd column":
							...
							round.getChannel().sendMessage(msg1111111111.build()).append(e.getMember().getAsMention())
									.queue(message -> {
										message.delete().queueAfter(5, TimeUnit.SECONDS);
										e.getChannel().getManager().putPermissionOverride(e.getMember(),
												EnumSet.of(Permission.VIEW_CHANNEL, Permission.MESSAGE_WRITE,
						...
						case "3rd column":
							...
							round.getChannel().sendMessage(msg11111111111.build()).append(e.getMember().getAsMention())
									.queue(message -> {
										message.delete().queueAfter(5, TimeUnit.SECONDS);
										e.getChannel().getManager().putPermissionOverride(e.getMember(),
												EnumSet.of(Permission.VIEW_CHANNEL, Permission.MESSAGE_WRITE,
